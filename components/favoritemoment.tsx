...
const FavoriteMoment = ({ favMoment }: Props) => {
  return (
    <a href={'#' && favMoment.redirectUrl} target="_blank" rel="noopener noreferrer">
      <div className="flex mx-2 p-2 bg-white bg-opacity-10 rounded-xl shadow-lg md:mx-3 transition duration-500 ease-in-out hover:shadow-2xl motion-reduce:transform-none"
        style={{
          ...
          <div className="flex items-center">
            ...
            <div className="flex justify-evenly items-center text-sm font-medium my-5 sm:mt-2 sm:mb-4">
              ...
              <div className="flex items-center mr-2">
                <Image
                  src={favMoment.User.image}
                  alt={favMoment.User.name}
                  width={25}
                  height={25}
